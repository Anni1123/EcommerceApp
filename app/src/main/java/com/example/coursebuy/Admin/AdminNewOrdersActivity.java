...
import com.example.coursebuy.Model.AdminOrders;
...
public class AdminNewOrdersActivity extends AppCompatActivity {
        ...
        FirebaseRecyclerAdapter<AdminOrders, AdminOrdersViewHolder> adapter =
                new FirebaseRecyclerAdapter<AdminOrders, AdminOrdersViewHolder>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull AdminOrdersViewHolder holder, final int position, @NonNull final AdminOrders model)
                    {
                        ...
                        holder.userPhoneNumber.setText("Phone: " + model.getPhonr());
    ...
    public static class AdminOrdersViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public AdminOrdersViewHolder(View itemView)
        {
            ...
            userShippingAddress = itemView.findViewById(R.id.orderaddress);
            ShowOrdersBtn = itemView.findViewById(R.id.showdetails);
        }
    }
